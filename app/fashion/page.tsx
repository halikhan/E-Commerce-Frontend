...
const subcategories = [
  { name: "Women's Clothing", count: 456, href: "/fashion/women" },
  { name: "Men's Clothing", count: 234, href: "/fashion/men" },
  { name: "Shoes", count: 189, href: "/fashion/shoes" },
  { name: "Accessories", count: 123, href: "/fashion/accessories" },
  { name: "Bags", count: 98, href: "/fashion/bags" },
  { name: "Jewelry", count: 87, href: "/fashion/jewelry" },
]
...
const brands = ["Zara", "H&M", "Nike", "Adidas", "Levi's", "Coach", "Gucci", "Prada"]
...
export default function FashionPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 max-w-md mx-8">
              <div className="relative">
                ...
                <Input placeholder="Search fashion..." className="pl-10" />
              </div>
            </div>
      ...
      {/* Hero Section */}
      <section className="relative h-64 bg-gradient-to-r from-pink-600 to-rose-600 overflow-hidden">
        <div className="absolute inset-0 bg-black/20" />
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="text-white max-w-2xl">
            <div className="flex items-center gap-2 mb-4">
              <Sparkles className="h-6 w-6" />
              <Badge className="bg-yellow-500 text-black">New Collection</Badge>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Fashion Store</h1>
            <p className="text-xl text-white/90 mb-6">Discover the latest trends and timeless classics in fashion</p>
              ...
              <Link key={subcategory.name} href={subcategory.href}>
                <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                    ...
                    {colors.map((color) => (
                      <button
                        ...
                        className={`w-8 h-8 rounded-full border-2 ${
                          selectedColors.includes(color.value) ? "border-gray-800 scale-110" : "border-gray-300"
                        } transition-all`}
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6 p-4 bg-white rounded-lg shadow-sm border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-600">Showing {products.length} of 2,567 products</span>
              </div>
                ...
                >
                  <CardContent className="p-0">
                    <div className="relative overflow-hidden">
                      ...
                      />
                      <Badge className="absolute top-3 left-3 bg-pink-500 text-white">{product.badge}</Badge>
                      {!product.inStock && (
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-bold text-lg mb-3 group-hover:text-pink-600 transition-colors">
                        {product.name}
                      </h3>
